...
$validationText = & npx powerbi-report-author validate $ReportRoot --pretty 2>&1
...
try {
    ...
    if (
        ($validationJson.data.result -eq "succeeded" -or $validationJson.data.result -eq "succeededWithWarnings") -and
